      ...
      >
        ...
        <div className="max-w-2xl mx-auto text-center px-4 mb-12 mt-48">
          <div className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">
            Tính năng nổi bật{" "}
            <span className="text-teal-400 dark:text-teal-300 font-bold">FLearning</span>
          </div>
          <p className="text-gray-500 dark:text-gray-400">
            FLearning vận dụng AI trong việc cá nhân hóa khóa học phù hợp với học
            sinh.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 h-[250px]"></div>
      </section>
      <div className="mt-32">
        <MoreSection />
      </div>
       ...
       <div className="relative bg-gradient-to-br from-[#49BBBD] via-[#3da8aa] to-[#2d9597] dark:from-[#1a4a4c] dark:via-[#153f41] dark:to-[#0f3436] rounded-t-[40rem] h-[600px] z-10 overflow-hidden">
         ...
         <div className="absolute inset-0">
           ...
           <div className="absolute top-32 right-12 w-20 h-20 border border-white/15 rounded-full animate-bounce" style={{animationDelay: '1.2s'}}></div>
           <div className="absolute top-48 left-1/3 w-12 h-12 bg-white/5 rounded-lg rotate-12 animate-pulse" style={{animationDelay: '2.4s'}}></div>
           <div className="absolute top-64 right-1/4 w-24 h-24 border-2 border-white/8 rounded-full animate-bounce" style={{animationDelay: '0.8s'}}></div>
           <div className="absolute top-80 left-1/2 w-8 h-8 bg-white/12 rounded-full animate-pulse" style={{animationDelay: '1.6s'}}></div>
           ...
           <div className="absolute top-40 right-1/3 flex items-center justify-center w-20 h-20 bg-white/8 backdrop-blur-sm rounded-2xl border border-white/15 animate-float" style={{animationDelay: '1.8s'}}>
             <span className="text-3xl">🎓</span>
           </div>
           <div className="absolute top-56 left-2/3 flex items-center justify-center w-14 h-14 bg-white/12 backdrop-blur-sm rounded-2xl border border-white/18 animate-float" style={{animationDelay: '2.2s'}}>
           ...
           <div className="absolute top-40 left-1/3 w-1 h-1 bg-white/30 rounded-full animate-ping" style={{animationDelay: '1s'}}></div>
           <div className="absolute top-60 right-1/4 w-1 h-1 bg-white/50 rounded-full animate-ping" style={{animationDelay: '2s'}}></div>
         </div>
           ...
           <div className="text-center max-w-2xl mx-auto px-6">
             ...
             <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
               <button className="group relative bg-white/20 backdrop-blur-sm px-8 py-4 rounded-2xl hover:bg-white/30 transition-all duration-300 border border-white/30 hover:border-white/50 hover:scale-105 shadow-lg hover:shadow-xl">
                 <span className="text-white font-semibold text-lg">Khám phá ngay</span>
               ...
               <button className="group bg-transparent backdrop-blur-sm px-8 py-4 rounded-2xl hover:bg-white/10 transition-all duration-300 border border-white/20 hover:border-white/40">
                 <span className="text-white/90 font-medium text-lg">Tìm hiểu thêm</span>
               </button>
             </div>
