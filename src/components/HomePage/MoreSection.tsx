      ...
      <section className="container mx-auto px-6 mt-32">
        ...
        <div className="text-center max-w-3xl mx-auto mb-32" data-speed="0.8">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed gsap-text-zoom">
            FLearning là nền tảng cho sinh viên FPT cung cấp khóa học bằng AI
            thông minh cho sinh viên, cho phép sinh tìm kiếm được khóa học phù
            hợp cho bản thân họ. Hệ thống FLearning còn đồng thời cho phép giảng
