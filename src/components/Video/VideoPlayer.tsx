...
export default function YouTubeStylePlayer({ src, poster, urlVtt, tracks }: Props) {
  ...
  useEffect(() => {
    ...
    if (Hls.isSupported()) {
      ...
      hls.on(Hls.Events.SUBTITLE_TRACKS_UPDATED, (_ev: unknown, d: unknown) => {
      ...
      hls.on(Hls.Events.MANIFEST_PARSED, (_e: unknown, data: ManifestParsedData) => {
      ...
      hls.on(Hls.Events.LEVEL_SWITCHED, (_e: unknown, d: LevelSwitchedData) => {
